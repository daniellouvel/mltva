...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.labelForniseur = QLabel("Client :")
        ...
        self.comboBoxpayment = QComboBox()
        self.comboBoxpayment.setObjectName("comboBoxpayment")
        self.gridLayout.addWidget(self.label_2, 2, 0)
        self.gridLayout.addWidget(self.comboBoxpayment, 2, 1)
        ...
        self.gridLayout.addWidget(self.labelComentaire, 7, 0)
        self.gridLayout.addWidget(self.lineEditComentaire, 7, 1)
        ...
        self.lineEdimontanttotal = QLineEdit()
        self.lineEdimontanttotal.setObjectName("lineEdimontanttotal")
        self.lineEdimontanttotal.setMaximumWidth(120)
        ...
        footer.addWidget(self.lineEdimontanttotal)
