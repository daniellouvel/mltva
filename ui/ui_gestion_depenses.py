...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setWindowTitle("Gestion des Dépenses")
        ...
        header = QHBoxLayout()
        self.label = QLabel()
        self.label.setText("<html><body><p align='center'><span style='font-size:18pt; font-weight:700;'>Gestion Des Dépenses : </span></p></body></html>")
        ...
        self.gridLayout.addWidget(self.labelMontantTVA, 4, 0)
        self.gridLayout.addWidget(self.lineEditMontantTVA, 4, 1)
        ...
        self.gridLayout.addWidget(self.labelCommentaire, 5, 0)
        self.gridLayout.addWidget(self.lineEditCommentaire, 5, 1)

        self.checkBoxValidation = QCheckBox("Validation")
        self.checkBoxValidation.setObjectName("checkBoxValidation")
        self.gridLayout.addWidget(self.checkBoxValidation, 6, 1)

        self.checkBox2emeLigne = QCheckBox("2ème ligne (TVA différente)")
        self.checkBox2emeLigne.setObjectName("checkBox2emeLigne")
        self.gridLayout.addWidget(self.checkBox2emeLigne, 7, 0, 1, 2)

        self.labelTTC2 = QLabel("TTC (2ème) :")
        self.lineEditMontant2 = QLineEdit()
        self.lineEditMontant2.setObjectName("lineEditMontant2")
        self.gridLayout.addWidget(self.labelTTC2, 8, 0)
        self.gridLayout.addWidget(self.lineEditMontant2, 8, 1)

        self.labelTVA2 = QLabel("TVA (2ème) :")
        self.comboBoxTVA2 = QComboBox()
        self.comboBoxTVA2.setObjectName("comboBoxTVA2")
        self.gridLayout.addWidget(self.labelTVA2, 9, 0)
        self.gridLayout.addWidget(self.comboBoxTVA2, 9, 1)
        ...
        self.push_scan_facture = QPushButton("📄 Scanner factures")
        self.push_scan_facture.setObjectName("push_scan_facture")
        self.push_import_email = QPushButton("📧 Import email")
        self.push_import_email.setObjectName("push_import_email")
        ...
        btn_layout.addWidget(self.push_scan_facture)
        btn_layout.addWidget(self.push_import_email)
        ...
        headers = ["Repère", "Date", "Fournisseur", "TTC", "Taux TVA", "Montant TVA", "Validation", "Commentaire"]
        ...
        footer = QHBoxLayout()
        self.labeltotalttc = QLabel("Total TTC")
        self.labeltotalttc.setObjectName("labeltotalttc")
        self.lineEdittotalttc = QLineEdit()
        self.lineEdittotalttc.setObjectName("lineEdittotalttc")
        self.lineEdittotalttc.setMaximumWidth(120)
        self.labelmontanttva = QLabel("Total Montant TVA")
        self.labelmontanttva.setObjectName("labelmontanttva")
        self.lineEditmontanttva = QLineEdit()
        self.lineEditmontanttva.setObjectName("lineEditmontanttva")
        self.lineEditmontanttva.setMaximumWidth(120)
        ...
        footer.addWidget(self.lineEdittotalttc)
        footer.addWidget(self.labelmontanttva)
        footer.addWidget(self.lineEditmontanttva)
        footer.addStretch()
