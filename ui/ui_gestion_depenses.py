...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.labelComentaire = QLabel("Commentaire :")
        self.lineEditComentaire = QLineEdit()
        self.lineEditComentaire.setObjectName("lineEditComentaire")
        self.gridLayout.addWidget(self.labelComentaire, 5, 0)
        self.gridLayout.addWidget(self.lineEditComentaire, 5, 1)
        ...
        self.pushButtonSuprimer = QPushButton("Supprimer")
        self.pushButtonSuprimer.setObjectName("pushButtonSuprimer")
        ...
        footer.addStretch()
        footer.addWidget(self.pushButtonSuprimer)
